...
# Supplementary S6: Belt Entrainment and Interoceptive
# Contribution to Detection.
#
# Sources after analysis_belt.R.
# Uses qcFull and s5s already loaded by MainAnalysis.R.
# Output: s6_entrainment_results.csv
# ============================================================

message("\nS6: Belt Entrainment -> Detection Advantage")
...
readr::write_csv(s6_results,
                 paste0(RESULTS_DIR, "s6_entrainment_results.csv"))
message("Saved: s6_entrainment_results.csv")
message("analysis_s6_entrainment.R complete.")
