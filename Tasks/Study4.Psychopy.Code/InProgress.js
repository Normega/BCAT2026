...
function CounterCodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CounterCodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function judgebreathRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of judgebreathComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function judgeconfidenceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of judgeconfidenceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function judgearousal_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of judgearousal_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CalcThresholdsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CalcThresholdsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function TestTrialInstructRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of TestTrialInstructComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CompleteInstructRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CompleteInstructComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
