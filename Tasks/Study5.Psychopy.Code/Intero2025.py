...
trialNum = 0
cycleDuration = 1 #starting breath length (in s)
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='I:\\Shared drives\\Interoception 2025\\Task\\Intero2025.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    thisExp.nextEntry()
    # the Routine "StartupCode" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    for thisHeartbeatLoop in HeartbeatLoop:
        ...
        # keep track of which components have finished
        HeartCountComponents = [readyScreen, countScreen]
        ...
        # keep track of which components have finished
        HeartReportComponents = [beatReport, HRenter_text]
    ...
    # get names of stimulus parameters
    if HeartbeatLoop.trialList in ([], [None], None):
        params = []
    else:
        params = HeartbeatLoop.trialList[0].keys()
    # save data for this loop
    HeartbeatLoop.saveAsExcel(filename + '.xlsx', sheetName='HeartbeatLoop',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    ...
    # keep track of which components have finished
    EndPart1Components = [key_space_3, text_6]
