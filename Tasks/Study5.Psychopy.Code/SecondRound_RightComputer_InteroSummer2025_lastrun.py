...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='G:\\My Drive\\InteroSummer2025\\Task\\SecondRound_RightComputer_InteroSummer2025_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        ...
        languageStyle='LTR',
        depth=-1.0);
    port_taskcomplete = parallel.ParallelPort(address='0xD030')
    ...
    _key_space_allKeys = []
    # keep track of which components have finished
    CompleteInstructComponents = [key_space, text_4, port_taskcomplete]
    ...
    while continueRoutine:
        ...
        if port_taskcomplete.status == NOT_STARTED and t >= 0-frameTolerance:
            ...
            port_taskcomplete.status = STARTED
            win.callOnFlip(port_taskcomplete.setData, int(2))
